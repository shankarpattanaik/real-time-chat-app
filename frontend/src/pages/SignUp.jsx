    ...
    <div className="w-full h-[100vh] bg-slate-200 flex items-center justify-center">
      <div className="w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col gap-[30px]">
        <div className="w-full h-[200px] bg-[#20c7ff] rounded-b-[30%] shadow-gray-400 shadow-lg flex items-center justify-center">
          <h1 className="text-gray-900 font-bold text-[30px]">
            Welcome to <span className="text-white">ChatFlux</span>
          </h1>
        </div>
        <form
        ...
        >
          ...
          <button
            className="px-[20px] py-[10px] bg-[#20c7ff] rounded-2xl shadow-gray-300 shadow-lg text-[20px] w-[200px] mt-[20px] font-semibold hover:shadow-inner"
            disabled={loading}
          >
